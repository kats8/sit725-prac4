...
const uri = "mongodb+srv://sit725:sit725@sit725.63pic.mongodb.net/sitboard?retryWrites=true&w=majority";
...
client.connect(err => {
  collectionMessage = client.db("sitboard").collection("messages");
